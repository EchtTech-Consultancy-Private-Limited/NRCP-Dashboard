...
Route::middleware(['Admin','device'])->group(function () {
        ...
        Route::middleware(['StateUserPermission','preventBackHistory'])->group(function () {
            Route::group(['prefix' => 'states', 'as' => 'state.'], function () {
                ...
                Route::get('lform-list',[LFormController::class,'lFormList'])->name('lform-list');
                Route::get('lform-create',[LFormController::class,'lFormCreate'])->name('lform-create');
                Route::post('lform-store',[LFormController::class,'lFormstore'])->name('lform-store');
            });
        });
    });
