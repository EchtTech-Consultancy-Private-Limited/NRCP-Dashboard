...
<div class="container-fluid dashboard">
    <div class="ncdc-container form-tab">
        <div class="dashboard-filter">
            <form action="{{ route('national.p-form-update', $stateUserpForm->id) }}" method="post"
                id="line-suspected-store">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="text-align: right; font-size: 14px; margin-top: 5px;">
                                <input type="date" name="suspected_date"
                                    value="{{ old('suspected_date', $stateUserpForm->suspected_date) }}">
                            </p>
                        </div>
                    </div>
                    <div class="row" style="display: flex;justify-content: space-around;">
                        <div class="col-md-4">
                            <div class="addressBlock">
                                <p>
                                    ...
                                    <input type="text" name="name_of_health"
                                        value="{{ old('name_of_health', $stateUserpForm->name_of_health) }}" class="form-control">
                                ...
                                <p>
                                    ...
                                    <input type="text" name="designation_name"
                                        value="{{ old('designation_name', $stateUserpForm->designation_name) }}" class="form-control">
                                </p>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="emailBlock">
                                <p>
                                    ...
                                    <select name="type_of_health" id="type_of_health" class="form-control">
                                        <option value=""> Select state</option>
                                        @foreach ($states as $key => $state)
                                        <option value="{{ $state->name }}"
                                            {{ $state->name == $stateUserpForm->type_of_health ? 'selected' : '' }}>
                                            {{ ucwords($state->name) }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                {{-- <p >
                                    Aadhar Number: <br>
                                    <input type="text" name="aadhar_number" value="{{ old('aadhar_number', $stateUserpForm->aadhar_number) }}"
                        ...
                        <div class="addressBlock">
                                ...
                                <p> 
                                    ...
                                    <input type="text" name="address_hospital" class="form-control" value="{{ old('address_hospital', $stateUserpForm->address_hospital) }}">
                                ...
                                <p>
                                    Contact Number<br>
                                    <input type="text" name="main_contact_number" class="form-control"
                                        value="{{ old('main_contact_number', $stateUserpForm->contact_number) }}"
                                        maxlength="12" oninput="validateInput(this)">
                                </p>
                            ...
                            <tr id="row{{ $index + 1 }}">
                                ...
                                <td>
                                    <input type="text" name="aadhar_no[]"
                                        value="{{ $lineSuspectedCount->aadhar_number }}" maxlength="12"
                                ...
                                <td>
                                    <input type="text" name="contact_number[]"
                                        value="{{ $lineSuspectedCount->contact_number }}" maxlength="10"
                                        oninput="validateInput(this)">
                                </td>
                                <td>
                                    ...
                                    <select class="form-select form_district" aria-label="Default select "
                                        ...
                                        <option value="{{ $citie->id }}" @if($lineSuspectedCount->district ==
                                            $citie->id) selected @endif>
                                            {{ ucwords($citie->name) }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <td>
                                    ...
                                    --}}
                                    <select class="form-select pform_subdistrict" aria-label="Default select"
                                        name="sub_district_mandal[]" id="pform_subdistrict">
                                        <option value="">Please Select</option>
                                ...
                                <td>
                                    <select class="form-select" aria-label="Default select example"
                                        ...
                                        <option value="">Please Select</option>
                                        <option value="Suspected" @if($lineSuspectedCount->suspected_probable ==
                                            'Suspected') selected @endif>Suspected</option>
                                        <option value="Probable" @if($lineSuspectedCount->suspected_probable ==
                                            'Probable') selected @endif>Probable</option>
                                        <option value="Confirmed" @if($lineSuspectedCount->suspected_probable ==
                                            'Confirmed') selected @endif>Confirmed</option>
                                    </select>
                                </td>
                                <td>
                                    <select class="form-select form_district" aria-label="Default select"
                                        name="bit_incidence_district[]" id="form_district"
                                        subId="bit_incidence_subdistrict">
                                        @foreach ($cities as $citie)
                                        <option value="{{ $citie->id }}" @if($lineSuspectedCount->bit_incidence_district
                                            == $citie->id) selected @endif>
                                            {{ ucwords($citie->name) }}
                                        </option>
                                        @endforeach
                                ...
                                <td>
                                    <select class="form-select bit_incidence_subdistrict" aria-label="Default select"
                                        name="bit_incidence_sub_district[]" id="bit_incidence_subdistrict">
                                        <option value="">Please Select</option>
                                ...
                                <td>
                                    <input type="text" name="bit_incidence_village[]"
                                        value="{{ $lineSuspectedCount->bit_incidence_village }}">
                                </td>
                                <td>
                                    <select class="form-select" aria-label="Default select example"
                                        name="category_of_bite[]" id="category_of_bite">
                                        <option value="">Please Select</option>
                                        <option value="First" @if($lineSuspectedCount->category_of_bite == 'First')
                                            selected @endif>First</option>
                                        <option value="Second" @if($lineSuspectedCount->category_of_bite == 'Second')
                                            selected @endif>Second</option>
                                        <option value="Third" @if($lineSuspectedCount->category_of_bite == 'Third')
                                ...
                                <td>
                                    <select class="form-select" aria-label="Default select example"
                                        ...
                                        <option value="">Please Select</option>
                                        <option value="Complete" @if($lineSuspectedCount->status_of_pep == 'Complete')
                                            selected @endif>Complete</option>
                                        <option value="Partial" @if($lineSuspectedCount->status_of_pep == 'Partial')
                                            selected @endif>Partial</option>
                                        <option value="Nil" @if($lineSuspectedCount->status_of_pep == 'Nil') selected
                                            @endif>Nil</option>
                                        <option value="NA" @if($lineSuspectedCount->status_of_pep == 'NA') selected
                                            @endif>NA</option>
                                    </select>
                                </td>
                                <td>
                                    <input type="text" name="health_facility_name_institute[]"
                                        value="{{ $lineSuspectedCount->health_facility_name_institute }}">
                                </td>
                                <td>
                                    <select class="form-select health_facility_district" aria-label="Default select "
                                        ...
                                        <option value="">Please Select</option>
                                        @foreach ($cities as $citie)
                                        <option value="{{ $citie->id }}" @if($lineSuspectedCount->
                                            health_facility_district == $citie->id) selected @endif>
                                            {{ ucwords($citie->name) }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <td>
                                    <select class="form-select" aria-label="Default select example"
                                        ...
                                        <option value="">Please Select</option>
                                        <option value="Death in Hospital" @if($lineSuspectedCount->outcome_of_patient ==
                                            'Death in Hospital') selected @endif>Death in Hospital</option>
                                        <option value="LAMA" @if($lineSuspectedCount->outcome_of_patient == 'LAMA')
                                ...
                                <td>
                                    <select class="form-select" aria-label="Default select example"
                                        ...
                                        <option value="">Please Select</option>
                                        <option value="Stary Dog" @if($lineSuspectedCount->bite_from_stray == 'Stary
                                            Dog') selected @endif>Stary Dog</option>
                                        <option value="Pet Dog" @if($lineSuspectedCount->bite_from_stray == 'Pet Dog')
                                            selected @endif>Pet Dog</option>
                                        <option value="Cat" @if($lineSuspectedCount->bite_from_stray == 'Cat') selected
                                            @endif>Cat</option>
                                        <option value="Other" @if($lineSuspectedCount->bite_from_stray == 'Other')
                                            selected @endif>Other</option>
                                    </select>
                                </td>
                                <td>
                                    <input type="text" name="mobile_number[]"
                                        value="{{ $lineSuspectedCount->mobile_number }}" maxlength="10"
                                        oninput="validateInput(this)">
                                </td>
                                <td>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.add_more', function() {
            ...
            var rowHtml =
                ...
                i +
                '"><option value="">Please Select</option><option value="Stary Dog" @if((old('
            bite_from_stray ')[$index] ?? '
            ') == '
            Stary Dog ') selected @endif>Stary Dog</option>' +
                '<option value="Pet Dog" @if((old('
            bite_from_stray ')[$index] ?? '
            ') == '
            Pet Dog ') selected @endif>Pet Dog</option>' +
                '<option value="Cat" @if((old('
            bite_from_stray ')[$index] ?? '
            ') == '
            Cat ') selected @endif>Cat</option>' +
                '<option value="Other" @if((old('
            bite_from_stray ')[$index] ?? '
            ') == '
            Other
                ') selected @endif>Other</option></select></td><td><input type="text" name="mobile_number[]" class="name_list" maxlength="10" oninput="validateInput(this)"></td><td><input type="date" name="date[]" class="name_list"></td><td><button type="button" name="add" id="add' +
                i +
