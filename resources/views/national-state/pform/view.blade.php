                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="text-align: right; margin-right: 15%; font-size: 14px; margin-top: 5px;">
                                <input readonly type="date" name="suspected_date" value="{{ old('suspected_date', $stateUserpForm->suspected_date) }}">
                            </p>
                        </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <p >
                                ...
                                <input readonly type="text" name="name_of_health" value="{{ old('name_of_health', $stateUserpForm->name_of_health) }}">
                            ...
                            <p >
                                ...
                                <input readonly type="text" name="address_hospital" value="{{ old('address_hospital', $stateUserpForm->address_hospital) }}">
                            ...
                            <p >
                                ...
                                <input readonly type="text" name="designation_name" value="{{ old('designation_name', $stateUserpForm->designation_name) }}">
                            </p>
                        </div> 
                        ...
                        <div class="col-md-4">
                            <div class="emailBlock">
                                ...
                                <p >
                                    Email ID: <br>
                                    <input readonly type="email" name="email" value="{{ old('email', $stateUserpForm->email) }}">
                                    @if ($errors->has('email')) 
                                ...
                                <p >
                                    Aadhar Number: <br>
                                    <input readonly type="text" name="aadhar_number" value="{{ old('aadhar_number', $stateUserpForm->aadhar_number) }}" maxlength="12" oninput="validateInput(this)">
                        ...
                        <tbody>
                            ...
                            <tr id="row{{ $index + 1 }}">
                                <td>
                                    ...
                                    <input readonly type="hidden" name="p_form_count_id[]" value="{{ $lineSuspectedCount->id }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="name[]" value="{{ $lineSuspectedCount->name }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="age[]" value="{{ $lineSuspectedCount->age }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="sex[]" value="{{ $lineSuspectedCount->sex }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="contact_number[]" value="{{ $lineSuspectedCount->contact_number }}" maxlength="10" oninput="validateInput(this)">
                                </td>
                                <td>
                                    <input readonly type="text" name="village[]" value="{{ $lineSuspectedCount->village }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="sub_district_mandal[]" value="{{ $lineSuspectedCount->sub_district_mandal }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="district[]" value="{{ $lineSuspectedCount->district }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="biting_animal[]" value="{{ $lineSuspectedCount->biting_animal }}">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input readonly type="text" name="bit_incidence_village[]" value="{{ $lineSuspectedCount->bit_incidence_village }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="bit_incidence_sub_district[]" value="{{ $lineSuspectedCount->bit_incidence_sub_district }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="bit_incidence_district[]" value="{{ $lineSuspectedCount->bit_incidence_district }}">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input readonly type="text" name="health_facility_name_institute[]" value="{{ $lineSuspectedCount->health_facility_name_institute }}">
                                </td>
                                <td>
                                    <input readonly type="text" name="health_facility_district[]" value="{{ $lineSuspectedCount->health_facility_district }}">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input readonly type="text" name="mobile_number[]" value="{{ $lineSuspectedCount->mobile_number }}" maxlength="10" oninput="validateInput(this)">
                                </td>
                                <td>
                                    <input readonly type="date" name="date[]" value="{{ $lineSuspectedCount->date }}">
                                </td>
