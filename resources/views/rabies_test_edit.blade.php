...
<div class="container-fluid">
    <div class="dashboard">
        <div class="dashboard-filter mb-4">
            <form action="{{ route('rabies-update') }}" method="post" class="one_time_submit_form" id="rabies_detail_test">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" aria-label="Default select example"
                                ...
                                value="{{$rabiestest->number_of_patients}}">
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" aria-label="Default select example"
                                name="numbers_of_sample_recieved" id="numbers_of_sample_recieved"
                                value="{{$rabiestest->numbers_of_sample_recieved}}">
                    ...
                    <div class="col-lg-2 col-md-2 col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="typefdte" id="typefdte">
                                ...
                                <option value='For diagnosis'
                                    <?php if($rabiestest->type == 'For diagnosis'){ echo 'selected'; }else{ echo '';} ?>>
                                    For diagnosis</option>
                                <option value='Titre estimation'
                                    <?php if($rabiestest->type == 'Titre estimation'){ echo 'selected'; }else{ echo '';} ?>>
                                    Titre estimation</option>
                            </select>
                            @error('type')
                            <span class="form-text text-muted">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="method_of_diagnosis" id="method_of_diagnosis">
                                ...
                                <option value='NAAT'
                                    <?php if($rabiestest->method_of_diagnosis == 'NAAT'){ echo 'selected'; }else{ echo '';} ?>>
                                    NAAT</option>
                                <option value='ELISA'
                                    <?php if($rabiestest->method_of_diagnosis == 'ELISA'){ echo 'selected'; }else{ echo '';} ?>>
                                    ELISA</option>
                                <option value='PFFIT'
                                    <?php if($rabiestest->method_of_diagnosis == 'PFFIT'){ echo 'selected'; }else{ echo '';} ?>>
                                    PFFIT</option>
                                <option value='DFAT'
                                    <?php if($rabiestest->method_of_diagnosis == 'DFAT'){ echo 'selected'; }else{ echo '';} ?>>
                                    DFAT</option>
                                <option value='OTHERS'
                                    <?php if($rabiestest->method_of_diagnosis == 'OTHERS'){ echo 'selected'; }else{ echo '';} ?>>
                                    OTHERS</option>
                            </select>
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" aria-label="Default select example"
                                name="numbers_of_test" id="numbers_of_test" value="{{$rabiestest->numbers_of_test}}">
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" aria-label="Default select example"
                                name="numbers_of_positives" id="numbers_of_positives"
                                value="{{$rabiestest->numbers_of_positives}}">
                            <small id="lims-error" class="form-text text-muted">
                            </small>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" aria-label="Default select example"
                                name="numbers_of_intered_ihip" id="numbers_of_intered_ihip"
                                value="{{$rabiestest->numbers_of_intered_ihip}}">
                        </div>
                    </div>
