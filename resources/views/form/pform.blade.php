          ...
          <div class="form-tab">
            <div class="bootstrap-tab">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="nav-add-death-record" role="tabpanel" aria-labelledby="nav-profile-tab"> nav add death record profile tab TAB 2 Lorem ipsum dolor sit amet. </div>
                <div class="tab-pane fade" id="nav-record-aggregate-data" role="tabpanel" aria-labelledby="nav-contact-tab">nav-record-aggregate-data Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit, consequuntur. Laborum, placeat. </div>
                <div class="tab-pane fade" id="nav-submit-null-report" role="tabpanel" aria-labelledby="nav-submit-tab">nav submit null report lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit, consequuntur. Laborum, placeat. </div>
              </div>
            </div>
          </div>
        </div>
