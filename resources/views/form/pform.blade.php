                        ...
                        <div class="bootstrap-tab">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="nav-add-patient-record" role="tabpanel"
                                    ...
                                    <form action="{{ route('pform.store') }}" method="post" enctype="multipart/form-data" class="myPForm">
                                        @csrf
                                        <div class="row bg-c-gray">
                                                    ...
                                                    <div class="w-100 mr-3">
                                                        <select name="country_code" id="country_code" class="form-control mt-0">
                                                            ...
                                                            @foreach ($countryes as $key => $country)
                                                                <option value="{{ $country->id }}" {{ $country->id == old('country_code') ? 'selected' : '' }}>
                                                                    {{ $country->abbreviation }} +{{ $country->dial_code }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        @if ($errors->has('country_code'))
                                                            <span class="form-text text-muted">{{ $errors->first('country_code') }}</span>
                                                        @endif
                                                    </div>
                                                    <div class="w-100">
                                                        <input type="text" name="mobile_number" value="{{ old('mobile_number') }}" maxlength="10" oninput="validateInput(this)" id="mobile_number"
                                                            class="form-control" placeholder="Enter Your Mobile Number">
                                                        @if ($errors->has('mobile_number'))
                                                            <span class="form-text text-muted">{{ $errors->first('mobile_number') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="first_name" value="{{ old('first_name') }}" id="first-name"
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="middle_name" value="{{ old('middle_name') }}" maxlength="30" id="middle-name"
                                                        class="form-control" placeholder="Enter Your Middle Name">
                                                    @if ($errors->has('middle_name'))
                                                        <span class="form-text text-muted">{{ $errors->first('middle_name') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="last_name" value="{{ old('last_name') }}" id="last-name"
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="birth_of_date" value="{{ old('birth_of_date') }}" id="birth_of_date" class="form-control"
                                                        required>
                                                    @if ($errors->has('birth_of_date'))
                                                        <span class="form-text text-muted">{{ $errors->first('birth_of_date') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @if ($errors->has('gender'))
                                                        <span class="form-text text-muted">{{ $errors->first('gender') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" name="id_type" id="id-type" required>
                                                        ...
                                                        @if(old('id_type'))
                                                            <option value="{{ old('id_type') }}" selected>{{ old('id_type') }}</option>
                                                        @endif
                                                    ...
                                                    @if ($errors->has('id_type'))
                                                        <span class="form-text text-muted">{{ $errors->first('id_type') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="identification_number"
                                                        id="identification_number" value="{{ old('identification_number') }}" aria-describedby="Identification"
                                                        placeholder="Enter Your Identification Number" maxlength="16"
                                                        required>
                                                    @if ($errors->has('identification_number'))
                                                        <span class="form-text text-muted">{{ $errors->first('identification_number') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @if ($errors->has('pform_state'))
                                                        <span class="form-text text-muted">{{ $errors->first('pform_state') }}</span>
                                                    @endif
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @if ($errors->has('pform_city'))
                                                        <span class="form-text text-muted">{{ $errors->first('pform_city') }}</span>
                                                    @endif
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        ...
                                                        @if(old('taluka'))
                                                            <option value="{{ old('taluka') }}" selected>{{ old('taluka') }}</option>
                                                        @endif
                                                    ...
                                                    @if ($errors->has('taluka'))
                                                        <span class="form-text text-muted">{{ $errors->first('taluka') }}</span>
                                                    @endif
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="village"
                                                        id="village" value="{{ old('village') }}" aria-describedby="Identification"
                                                        placeholder="Enter Your Identification Number" maxlength="16"
                                                        required>
                                                    @if ($errors->has('village'))
                                                        <span class="form-text text-muted">{{ $errors->first('village') }}</span>
                                                    @endif
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="house_no"
                                                        id="house_no" value="{{ old('house_no') }}" aria-describedby="house_no"
                                                        placeholder="Enter Your House No" maxlength="20">
                                                    @if ($errors->has('house_no'))
                                                        <span class="form-text text-muted">{{ $errors->first('house_no') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="street_name"
                                                        id="street-name" value="{{ old('street_name') }}" aria-describedby="street-name"
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="landmark"
                                                        ...
                                                        placeholder="Enter Your Landmark" value="{{ old('landmark') }}" maxlength="40">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    value="{{ old('pincode') }}" oninput="validateInput(this)" placeholder="Enter Your PIN Code"
                                                        maxlength="8">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        ...
                                                        @if(old('provisinal_diagnosis'))
                                                            <option value="{{ old('provisinal_diagnosis') }}" selected>{{ old('provisinal_diagnosis') }}</option>
                                                        @endif
                                                        <option value="Anthrax">Anthrax</option>
                                                        <option value="Others">Others</option>                                                        
                                                    </select>
                                                    @if ($errors->has('provisinal_diagnosis'))
                                                        <span class="form-text text-muted">{{ $errors->first('provisinal_diagnosis') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @if ($errors->has('date_of_onset'))
                                                        <span class="form-text text-muted">{{ $errors->first('date_of_onset') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="opd_ipd"
                                                        aria-label="Default select example" id="opd_ipd"
                                                        required>
                                                        <option value=""> Select Your OPD-IPD
                                                        </option>
                                                        @if(old('opd_ipd'))
                                                            <option value="{{ old('opd_ipd') }}" selected>{{ old('opd_ipd') }}</option>
                                                        @endif
                                                        <option value="OPD">OPD</option>
                                                        <option value="IPD">IPD</option>
                                                    </select>
                                                    @if ($errors->has('opd_ipd'))
                                                        <span class="form-text text-muted">{{ $errors->first('opd_ipd') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        ...
                                                        @if(old('test_suspected'))
                                                            <option value="{{ old('test_suspected') }}" selected>{{ old('test_suspected') }}</option>
                                                        @endif
                                                        <option value="Anthrax">Anthrax</option>
                                                        <option value="Others">Others</option>                                                        
                                                    </select>
                                                    @if ($errors->has('test_suspected'))
                                                        <span class="form-text text-muted">{{ $errors->first('test_suspected') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        ...
                                                        @if(old('type_of_sample'))
                                                            <option value="{{ old('type_of_sample') }}" selected>{{ old('type_of_sample') }}</option>
                                                        @endif
                                                    ...
                                                    @if ($errors->has('type_of_sample'))
                                                        <span class="form-text text-muted">{{ $errors->first('type_of_sample') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="test_resquested"
                                                        ...
                                                        @if(old('test_resquested'))
                                                            <option value="{{ old('test_resquested') }}" selected>{{ old('test_resquested') }}</option>
                                                        @endif
                                                        <option label="Microscopy- Gram Stain" value="Microscopy- Gram Stain">
                                                            Microscopy- Gram Stain</option>
                                                        <option label="Gamma Phage Lysis" value="Gamma Phage Lysis">Gamma
                                                            Phage Lysis</option>
                                                        <option label="Culture" value="Culture">Culture</option>
                                                        <option label="PCR -Toxin/Capsule/Direct clinical sample"
                                                            value="PCR -Toxin/Capsule/Direct clinical sample">PCR -Toxin/Capsule/Direct clinical
                                                            sample</option>    
                                                    </select>
                                                    @if ($errors->has('test_resquested'))
                                                        <span class="form-text text-muted">{{ $errors->first('test_resquested') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="form-group">
                                                    <label for="OPD-IPD">Sample Collection Date (If Collected)<span
                                                            class="star">*</span></label>
                                                    <input type="date" name="sample_date" value="{{ old('sample_date') }}" class="form-control"
                                                        id="sample_date" aria-describedby="Date of Sample Collection"
                                                        required>
                                                    @if ($errors->has('sample_date'))
                                                        <span class="form-text text-muted">{{ $errors->first('sample_date') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
