              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="nav-add-patient-record" role="tabpanel" aria-labelledby="nav-home-tab">
                  ...
                  <form action="{{ route('lform.store') }}" method="post" enctype="multipart/form-data" class="myPForm"> 
                    ...
                    <input type="hidden" value="l_form" name="form_type">  
                          ...
                          <tbody> 
                            ...
                            <tr>
                              ...
                              <td class="text-nowrap ">
                                ...
                                <a href="{{ route('lform.delete',$pForm->id) }}" class="btn bg-danger action-btn" title="Delete">
                                    ...
                                    <div class="form-tab m-0 ">
                                      <div class="bootstrap-tab">
                                        <div class="tab-content" id="myTabContent">
                                          ...
                                          <form action="{{ route('lform.update', $pForm->id) }}" method="post" class="myForm"> 
                                            @csrf
                                            <input type="hidden" value="l_form" name="form_type">
                                            <div class="row bg-c-gray">
                                              <div class="col-lg-12 col-md-12">
