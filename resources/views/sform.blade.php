...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                ...
                <div class="container-fluid">
                    <div class="panel-body">
                                ...
                                <div class="row m-0">
                                    <div class="col-xs-4">
                                        <div class="form-group "
                                            ...
                                            <select
                                                ...
                                                name="village" ng-change="getSformUnsubmittedData();getDocumentId();"
                                    ...
                                    <div class="form-group col-xs-2 ng-hide"
                                        ...
                                        <select
                                            ...
                                            ng-required="
                                            facilityinfo.health_facility_urban_rural===2"
                                            name="ward" ng-change="getSformUnsubmittedData();getDocumentId();"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="3" rowspan="2"><b>
                                                        Number of cases of deaths <br>
                                                         <a href="#report-death-case" id="report-death-case-link" >[click here
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="" type="text" value="" id="onlyfeverlessthan7days_form_count_male_total"
                                                        class="form-control"
                                                        readonly="readonly" tabindex="-1"></td>
                                                ...
                                                <td><input name="pformdeathcountfemale" type="text" value="" id="onlyfeverlessthan7days_form_count_female_total"
                                                        class="form-control"
                                                        readonly="readonly" tabindex="-1"></td>

                                                <td><input name="pformdeathcountfemale" type="text" value="" id="onlyfeverlessthan7days_form_count_grand_total"
                                                        class="form-control"
                                                        readonly="readonly" tabindex="-1"></td>
                        ...
                        <div>
                            ...
                            <div class="panel-group sform-accordion" id="accordion1" role="tablist"
                                aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="aggregationSummary1">
                                        <h4 class="panel-title" id="report-death-case">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion1"
                                                data-target="#aggregationSummary" aria-expanded="true" id="aggregationSummary-link"
                                            ...
                                            <form class="form-compact ng-pristine ng-invalid ng-invalid-required"
                                                ...
                                                <div class="row m-0">
                                                    <div class="form-group col-xs-4"
                                                        ...
                                                        <select class="form-control  " id="village " ng-required="
                                                            facilityinfo.health_facility_urban_rural !=2"
                                                            name="village"
                                ...
                                <div class="alert alert-success" style="margin-top: 5px" role="alert">Data Saved
                                    Successfully</div>
    ...
    <div id="target">
        <div class="panel-group sform-accordion" id="accordion2" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="DeathPatientformId1">
                    <h4 class="panel-title">
                        <a role="button" data-toggle="collapse" data-parent="#accordion2"
                            data-target="#DeathPatientformId" aria-expanded="true" aria-controls="collapseOne">
                            <span class="tooltipid tooltipstered" data-placement="right">2. Reporting
                ...
                <div id="DeathPatientformId" class="panel-collapse collapse in" role="tabpanel"
                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-left: px; padding-left: 8px; padding-right: 2px;">
                            <div class="col-xs-12">
                                <div>
                                    <span class="glyphicon glyphicon-hand-right"></span>&nbsp;&nbsp;&nbsp;Enter
                                    data accurately and completely
                                </div>
                            </div>
                        </div>

                        <form name="deathcaseform" novalidate="" class="form-compact deathcaseform"
                            autocomplete="off">
                            <fieldset style="background-color: aliceblue;">
                                <div class="row">
                                    <label for="mobileno" class="col-xs-2 control-label"
                                        style="margin-top: 5px; max-width: 123px;"><span
                                            class="tooltipid tooltipstered" data-placement="right">Name:</span>
                                    </label>
                                    ...
                                    <div class="form-group col-xs-2">
                                        <label for="firstname" class="labelchange">2.2. First
                                            ...
                                            type="text" ng-pattern="/^[a-zA-Z'.,-]{0,150}$/"
                                            required="required">
                                        <div class="error ng-hide"
                                            ng-show=" deathcaseform.firstname.$dirty &amp;&amp;  deathcaseform.firstname.$invalid">
                                            <small ng-show=" deathcaseform.firstname.$error.required">
                                                Please Enter Name. </small> <small class="error ng-hide"
                                                ng-show=" deathcaseform.firstname.$error.pattern">
                                                Please Enter Valid First Name. </small>
                                        </div>
                                    </div>
                                    <div class="form-group col-xs-2">
                                        <label for="middlename" class="labelchange" style="min-width: 103px">2.3.
                                            Middle
                                            Name</label> <input class="form-control  " id="middlename"
                                            name="middlename" ng-pattern="/^[a-zA-Z'.,-]{0,150}$/" type="text"
                                            value="">
                                        <div class="error ng-hide"
                                    ...
                                    <div class="form-group col-xs-2">
                                        <label for="lastname" class="labelchange">2.4. Last
                                            ...
                                            name="lastname" ng-pattern="/^[a-zA-Z'.,-]{0,150}$/" type="text"
                                            value="">
                                        <div class="error ng-hide"
                                    ...
                                    <div class="form-group col-xs-4" style="margin-bottom: 0px;">
                                        <label class="radio-inline" style="font-weight: 700;">
                                            <input type="name=" agedob" id="inlineRadio2" value="dob"
                                                ng-click="clearfield('dob')"
                                                class="ng-pristine ng-untouched ng-valid ng-not-empty">
                                            <span class="tooltipid tooltipstered" data-placement="right">
                                                2.5. Date Of Birth</span><span ng-show="agedob=='dob'" span>
                                        </label> <label class="radio-inline" style="font-weight: 700;">
                                            <input type="radio"
                                                name="agedob                                                                    id="
                                                inlineRadio1" value="age" ng-click="clearfield('age')"
                                                class="ng-pristine ng-untouched ng-valid ng-not-empty">
                                            <span class="tooltipid tooltipstered" data-placement="right">
                                    ...
                                    <div class="form-group col-xs-2" ng-show="agedob=='dob'">
                                        ...
                                        <div class="input-group input-append date ageclass"
                                            ...
                                            <input type="text" value=""
                                                ...
                                                name="dateofbirth" placeholder="dd/mm/yyyy" required="required">
                                        ...
                                        <div class="error ng-hide"
                                            ...
                                            <small class="error" required>
                                                Please Enter Date of Birth.</small> <small class="error ng-hide">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-inline-block">
                                        <div class="radio">
                                            <label for="male">Male</label><input id="male" type="radio"
                                                name="optradio" class=" " value=" "
                                                required="required">
                                        </div>
                                        <div class="error  ">
                                    ...
                                    <div class="form-group d-inline-block">
                                        <div class="radio">
                                            ...
                                            <input id="female" type="radio" name="optradio" class=" "
                                    ...
                                    <div class="form-group d-inline-block">
                                        <div class="radio">
                                            ...
                                            <input id="transgander" type="radio" name="optradio"
        ...
        <div class="row">
            <div class="form-group col-md-3">
                <label for="identityType" class="labelchange">
                    <span class="tooltipid tooltipstered" data-placement="right">2.8. ID
                        Type <span>*</span>
                </label> <select class="form-control  " id="identityType" name="identityType"
                    ...
                    <option label="NREGS Job Card" value="object:39">NREGS Job
                        Card</option>
                    <option label="Photo ID issued by Recognized Educational Institution" value="object:40">Photo ID
                    ...
                    <option label="CGHS / ECHS Photo Card" value="object:47">
                        CGHS / ECHS Photo
                        Card</option>
                    <option label="Address Card having Name and Photo issued by Department of Posts  "
            ...
            <div class="form-group col-md-3  " ng-show="patient.identityType.patientidtype === 'Others'">
                <label for="other" class="labelchange" style="min-width: 140px">2.9.
                    Other
                    Id
                    type <span>*</span></label> <input
                    class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-required"
                    style="min-width: 140px" id="other" type="text"
                    ng-required="patient.identityType.patientidtype === 'Others'" name="other">
                <div class="error  ">
            ...
            <div class="form-group col-md-3" ng-show="patient.identityType.patientidtype !== 'Not Available'">
                <label for="patientidnumber" class="labelchange" style="min-width: 160px"><span
                        class="tooltipid ng-binding tooltipstered" data-placement="right">
                        2.10. Identification Number</span><span>*</span></label> <input class="form-control  "
                    id="patientidnumber" type="text" style="min-width: 140px"
                    ng-required="patient.identityType.patientidtype !== 'Not Available'"
                    ng-blur="getPDbyIdType(patient,'main')" name="patientidnumber" required="required">
                <div class="error  "
                    ng-show=" deathcaseform.patientidnumber.$dirty &amp;&amp;  deathcaseform.patientidnumber.$invalid">
                    <small class="error" ng-show=" deathcaseform.patientidnumber.$error.required">
    ...
    <div class="row">
        <div class="col-md-12">
            <label for="mobileno" class=" control-label" style="margin-top: 5px; max-width: 123px;">
    ...
    <div class="row m-0">
        ...
        <div class="form-group col-xs-2">
            ...
            <select class="form-control ng-pristine ng-untouched ng-not-empty ng-valid ng-valid-required"
                id="state" style="pointer-events: none;"
                ng-options="s as s.statename for s in statelist | orderBy:'statename'" ng-change="getDistrict()"
                name="state" ng-readonly="true" required="required" readonly="readOnly">
                <option value="" class="">-----Select-----</option>
                ...
                <option label="The Dadra And Nagar Haveli And Daman And Diu" value="object:89">The
            ...
            <div class="error  " ng-show=" deathcaseform.state.$dirty &amp;&amp;  deathcaseform.state.$invalid">
        ...
        <div class="form-group col-xs-2">
            <label for="district" class="labelchange">
            ...
            </label> <select class="form-control ng-pristine ng-untouched ng-not-empty ng-valid ng-valid-required"
                ...
                ng-change="gettaluks()" name="district" required="required" readonly="readOnly">
                <option value="" class="">-----Select-----</option>
            ...
            <div class="error  "
                ...
                <small class="error  " ng-show=" deathcaseform.district.$error.required">
        ...
        <div class="form-group col-xs-2">
            <label for="subdistrict" class="labelchange" style="min-width: 107px">
                ...
                id="subdistrict" name="subdistrict" ng-change="getwards():getVillagebySubdistCode()"
            ...
            <div class="error  "
                ...
                <small class="error  " ng-show="deathcaseform.subdistrict.$error.required">
        ...
        <div class="form-group col-xs-2" ng-show="facilityinfo.health_facility_urban_rural != 2">
            <label for="village" class="labelchange">
                ...
                ng-options="v as v.villagename for v in villagelist  | orderBy:'villagename'" required="required">
                <option value="" class="" selected="selected">
                    -----Select-----</option>
            ...
            <div class="error  " ng-show="deathcaseform.village.$dirty &amp;&amp; deathcaseform.village.$invalid">
        ...
        <!-- ng-options="v as v.wardname for v in wardSubcenterList  | orderBy:'wardname' -->
                            ...
                            <div class="form-group col-xs-2  " ng-show="facilityinfo.health_facility_urban_rural === 2">
                                ...
                                <div class="error  "
                                    ...
                                    <small class="error  " ng-show="deathcaseform.wardlistid.$error.required">
    ...
    <div class="form-group col-xs-2  " ng-show="hasRole('HFUSCUSER')">
        <label>Area <span>*</span></label> <select id="areaid" name="areaname"
            ng-options="m as m.areaname for m in areaList" ng-required="hasRole('HFUSCUSER')"
            class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-required">
            <option value="" class="" selected="selected">--Select--
            </option>
        </select>
        <div class="error  " ng-show="deathcaseform.areaname.$dirty &amp;&amp; deathcaseform.areaname.$invalid">
    ...
    <div class="row m-0">
        ...
        <div class="form-group col-xs-2">
            <label for="houseno" class="labelchange">
                <span class="tooltipid tooltipstered" data-placement="right">2.15. House
                    No</span></label> <input class="form-control ng-pristine ng-untouched ng-valid ng-empty"
        ...
        <div class="form-group col-xs-3">
            <label for="streetname" class="labelchange">
                ...
                class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength" id="streetname"
                type="text" name="streetname" ng-maxlength="100">
            <div class="error  "
                ng-show=" deathcaseform.streetname.$dirty &amp;&amp; deathcaseform.streetname.$invalid">
                <small class="error  " ng-show=" deathcaseform.streetname.$error.maxlength">
        ...
        <div class="form-group col-xs-3">
            <label for="landmark" class="labelchange">
                ...
                class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength" id="streetname"
                type="text" name="landmark" ng-maxlength="100">
            <div class="error  "
                ng-show=" deathcaseform.landmark.$dirty &amp;&amp; deathcaseform.landmark.$invalid">
                <small class="error  " ng-show=" deathcaseform.landmark.$error.maxlength">
                    Please Enter maximum 100 letters. </small>
            </div>
        </div>
    </div>
    ...
    <fieldset>
        ...
        <div class="row m-0">
            <div class="form-group col-xs-4">
                ...
                </label> <select id="deathcause" name="deathcause" class="form-control  "
            ...
            <div class="form-group col-xs-2  " ng-show="patient.deatcause.health_condition_name == 'Others'">
                <label for="otherdc" class="labelchange" style="min-width: 140px">3.2.
                    Other
                    Death
                    Cause <span>*</span></label> <input
                    class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength"
                    style="min-width: 140px" id="otherdc" type="text" max="128" ng-maxlength="128"
                    name="otherdc">
                <div class="error  "
            ...
            <div class="form-group col-xs-2">
                ...
                <div class="input-group input-append date dateclass" data-provide="datepicker">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-6" style="padding-left: 6px;">
                    <button class="btn btn-primary" ng-click="save_Patient_Details_of_deathCases()"
                    ...
                    <button class="btn btn-primary" ng-click="restReportingForm()">
                        <span class="tooltipid tooltipstered" data-placement="right">Reset</span></button>
                </div>
            </div>
            </form>
        </div>
        ...
        <button class="btn btn-primary printhide" ng-click="openSubmissionAlertModal()" style="margin: 5px;"><span
        ...
        <script>
            $(document).ready(function() {
                ...
                $('input[type=text]').each(function() {
                    $(this).on('keyup', function(e) {
                        ...
                        $(`#${arrayId[0]}_form_count_male_total`).val(Number($(
                            `#${arrayId[0]}_form_count_male_age_less_5`).val()) + Number($(
                            `#${arrayId[0]}_form_count_male_age_greater_5`).val()));

                        if ($(`#${arrayId[0]}_form_count_male_total`).val() == 0) {
                            $(`#${arrayId[0]}_form_count_male_total`).val("");
                        }

                        $(`#${arrayId[0]}_form_count_female_total`).val(Number($(
                            `#${arrayId[0]}_form_count_female_age_less_5`).val()) + Number($(
                            `#${arrayId[0]}_form_count_female_age_greater_5`).val()));
                        if ($(`#${arrayId[0]}_form_count_female_total`).val() == 0) {
                            $(`#${arrayId[0]}_form_count_female_total`).val("");
                        }

                        $(`#${arrayId[0]}_form_count_grand_total`).val(Number($(
                            `#${arrayId[0]}_form_count_male_total`).val()) + Number($(
                            `#${arrayId[0]}_form_count_female_total`).val()));
            ...
            // $("#report-death-case-link").click(()=>{
            //     $("#aggregationSummary").addClass('show');
            //     console.log("you clicled");
            //     $("#aggregationSummary-link").addClass('collapsed')
