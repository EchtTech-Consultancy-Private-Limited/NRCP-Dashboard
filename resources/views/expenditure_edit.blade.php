                    ...
                    <div class="tab-content" id="myTabContent">
                        <form action="{{ route('expenditure-update') }}" method="post" class="one_time_submit_form" id="rabies_detail_test">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" aria-label="Default select example"
                                            ...
                                            value="{{$expenditure->financial_year}}">
                                ...
                                <div class="col-lg-2 col-md-2 col-6">
                                    <div class="form-group">
                                        <label for="district">Fund Recieved<span class="star">*</span></label>
                                        <select class="form-select" aria-label="Default select example"
                                            name="fund_recieved" id="fund_recieved">
                                            <option value=""> Select
                                            </option>
                                            <option value='Yes'
                                                <?php if($expenditure->fund_recieved == 'Yes'){ echo 'selected'; }else{ echo '';} ?>>
                                                Yes</option>
                                            <option value='No'
                                                <?php if($expenditure->fund_recieved == 'No'){ echo 'selected'; }else{ echo '';} ?>>
                                                No</option>
                                        </select>
                                        @error('fund_recieved')
                                        <span class="form-text text-muted">{{ $message }}</span>
                                ...
                                <div class="col-lg-4 col-md-4 col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="Default select example"
                                            ...
                                            <option value='{{$expenditure->equipment_purchase}}' selected>
