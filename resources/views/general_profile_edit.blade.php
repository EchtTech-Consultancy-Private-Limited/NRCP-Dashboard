...
<div class="container-fluid">
    <div class="dashboard">
        <div class="dashboard-filter mb-4">
            <form action="{{ route('general-update') }}" method="post" class="one_time_submit_form" id="general_profile_submit">
                @csrf
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select state click-function" aria-label="Default select example"
                                ...
                                <option value="{{ $state->state_name }}"
                                    {{ ($general_profile->state == $state->state_name) ? 'selected' : ''}}>
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="hospital" maxlength="45" id="hospital"
                                value="{{$general_profile->hospital}}" class="form-control" />
                            @error('hospital')
                            <span class="form-text text-muted">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="designation" id="designation"
                                value="{{$general_profile->designation}}" class="form-control" />
                    ...
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_number" id="contact_number"
                                value="{{$general_profile->contact_number}}" minlength="10" maxlength="10"
                                oninput="validateInput(this)" class="form-control" />
                    ...
                    {{-- <div class="col-lg-3 col-md-3 col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" aria-label="Default select example" name="mou" id="mou" onChange="handleFilterValue()">
                                                ...
                                                <option value="yes" {{ ($general_profile->mou == 'yes') ? 'selected' : '' }}>Yes
                    </option>
