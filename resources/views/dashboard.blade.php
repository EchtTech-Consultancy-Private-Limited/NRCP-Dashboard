                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="" id="nav-add-patient-record" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select click-function"
                                                    aria-label="Default select example" id="district" name="district_name"
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6">
                                            <div class="form-group">
                                                ...
                                                <small id="diseasesSyndromes-error" class="form-text text-muted"> </small>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-6">
                                        ...
                                        <div class="row bg-white">
                                            <div class="col-md-5">
                                                <select class="form-control" name="type" id="type">
                                                    ...
                                                    <option value="1" {{ session('type') == '1' ? 'selected' : '' }}>
                                                        Deaths
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div id="graphical_view">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h1>Deaths by Age Group in India (Based on Male and Female)</h1>
