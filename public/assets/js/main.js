...
function addMore4() {
    ...
    let create_tr = $('<tr>').append(`
        <td></td>
        <td><input type="text" maxlength="150" name="animal_suspected_transmitting[transmitting_rabies_name_address][]"></td>
        <td><input type="text" maxlength="150" name="animal_suspected_transmitting[transmitting_rabies_relation][]"></td>
        <td class="">
            <a role="button" class="btn btn-danger remove-table-row float-right">
                <i class="fa fa-trash" aria-hidden="true"></i>
            </a>
...
contact_with_patient_checkbox.on("change", function() {
    ...
    if (element.is(":checked")) {
        ...
        let create_tr = $('<tr>').addClass(`row-${id}`).append(`
            ...
            <td><input type="text" oninput="validateName(this);" name="${contact_with_patient_value}[relation_with_${contact_with_patient_value}_name]"></td>
            <td><input type="text" maxlenght="200" name="${contact_with_patient_value}[relation_with_${contact_with_patient_value}_address]"></td>
            <td><input type="text" oninput="validateInput(this);" maxlength="10" name="${contact_with_patient_value}[relation_with_${contact_with_patient_value}_contact_number]"></td>
        `);
